                  ...
                  <>
                    {navigation.map((i) => (
                      <Link
                        key={i.item}
                        href={i.href}
                        className="w-full px-4  -ml-4 text-gray-500 rounded-md dark:text-gray-300 hover:text-indigo-500 focus:text-indigo-500 focus:bg-indigo-100 dark:focus:bg-gray-800 focus:outline-none"
                      >
                        {i.item}
                      </Link>
                    ))}
